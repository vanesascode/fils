  ...
  return (
    <>
      <div className="flex flex-col items-center relative ">
        ...
        <div className="text-light-2 fixed bottom-0 md:text-[12px] text-[10px] justify-center flex  flex-wrap  rounded-t-3xl bg-glassmorphism p-4 backdrop-blur-lg xs:px-7 w-full">
