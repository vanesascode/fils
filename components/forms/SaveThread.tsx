    ...
    <>
      ...
      {addBookmarks && (
        <div className="fixed bottom-20  left-0 w-full h-full flex justify-center items-end  z-50 ">
          <div className="bg-light-2 dark:bg-green-1 px-[30px] py-[20px] rounded-lg shadow text-center gap-2 text-dark-1 flex items-center">
            <div className="text-base-semibold">Added to your bookmarks</div>
            <Link
              href={`/profile/${currentUserId}`}
              className="text-light-1 dark:text-gray-400 text-base-bold sm:text-body-bold "
            >
              View
            </Link>
          </div>
